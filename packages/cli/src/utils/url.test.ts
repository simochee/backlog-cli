...
describe("openUrl", () => {
	it("open パッケージに URL を渡してブラウザを開く", async () => {
		await openUrl("https://example.backlog.com/dashboard");
		expect(open).toHaveBeenCalledWith("https://example.backlog.com/dashboard");
	});
});

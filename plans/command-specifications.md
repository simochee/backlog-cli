...
| `--json`     |      | string   | —                  | JSON出力。フィールド名をカンマ区切りで指定可           |
...
| --------------- | ---- | ------- | ---- | ---------- | ----------------------------------------- |
| `--space`       |      | string  | No   | —          | スペースホスト名（例: `xxx.backlog.com`） |
...
| 引数/オプション | 短縮 | 型     | 必須 | デフォルト         | 説明                 |
| --------------- | ---- | ------ | ---- | ------------------ | -------------------- |
| `--space`       |      | string | No   | アクティブスペース | 対象スペースホスト名 |
...
| 引数/オプション | 短縮 | 型      | 必須 | デフォルト | 説明                 |
| --------------- | ---- | ------- | ---- | ---------- | -------------------- |
| `--space`       |      | string  | No   | 全スペース | 対象スペースホスト名 |

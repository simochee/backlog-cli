...
| --------------- | ---- | ------- | ---- | ---------- | ----------------------------------------- |
| `--space`       | `-s` | string  | No   | —          | スペースホスト名（例: `xxx.backlog.com`） |
...
| 引数/オプション | 短縮 | 型     | 必須 | デフォルト         | 説明                 |
| --------------- | ---- | ------ | ---- | ------------------ | -------------------- |
| `--space`       | `-s` | string | No   | アクティブスペース | 対象スペースホスト名 |
...
| 引数/オプション | 短縮 | 型      | 必須 | デフォルト | 説明                 |
| --------------- | ---- | ------- | ---- | ---------- | -------------------- |
| `--space`       | `-s` | string  | No   | 全スペース | 対象スペースホスト名 |
...
| `--space`       | `-s` | string | No   | スペース単位の設定を取得                 |

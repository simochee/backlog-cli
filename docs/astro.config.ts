				...
				},
				{
					...
					items: [
						...
						},
						{
							...
							collapsed: true,
							items: [
								{ label: "概要", link: "/commands/status/" },
								{
									label: "status list",
									link: "/commands/status/list/",
								},
								{
									label: "status create",
									link: "/commands/status/create/",
								},
								{
									label: "status edit",
									link: "/commands/status/edit/",
								},
								{
									label: "status delete",
									link: "/commands/status/delete/",
								},
							],
						},
						{
						...
						{ label: "backlog dashboard", link: "/commands/dashboard/" },

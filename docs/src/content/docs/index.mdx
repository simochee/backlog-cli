...
<CardGrid>
	<Card title="108 コマンド" icon="rocket">
		課題、PR、Wiki、ドキュメント、通知、Webhook、チーム管理など、Backlog API の主要な機能を 108
		のコマンドでカバーしています。
	</Card>
...
<CardGrid>
	...
	/>
	<LinkCard title="コマンドリファレンス" href="/commands/auth/" description="全 108 コマンドの詳細なリファレンス" />
	<LinkCard
		title="AI エージェント連携"

...
### Trivial Accessors
Standard getters and setters like getName() must not have JSDoc (e.g., Avoid /** Gets the name */).
...
### Property Comments
For interface properties, use single-line JSDoc /** description */ only if the property name is ambiguous.